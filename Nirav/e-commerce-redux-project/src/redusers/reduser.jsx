...
const initialStateCart = {
    ...
    cartProduct : localStorage.getItem('BuyCartProduct') ? JSON.parse(localStorage.getItem('BuyCartProduct'))  : []
    // cartProduct: localStorage.getItem('token')
    //     ? localStorage.getItem('BuyCartProduct')
    //         ? [...JSON.parse(localStorage.getItem('BuyCartProduct')), ...JSON.parse(localStorage.getItem('token'))[0].cartProducts]
    //         : JSON.parse(localStorage.getItem('token'))[0].cartProducts
    //     : []
}
